...
```bash
git clone https://github.com/Mixednucolander/FinSight-AI-466.git
cd FinSight-AI-466
python setup.py
```
...
![CI](https://github.com/Mixednucolander/FinSight-AI-466/actions/workflows/ci.yml/badge.svg)
...
```bash
git clone https://github.com/Mixednucolander/FinSight-AI-466 ~/work/FinSight-AI
cd ~/work/FinSight-AI
...
<!-- Last updated: 2026-06-06 20:04:09 -->
